-- hive comments begin with "--" 
-- 
-- from http://www.lichun.cc/blog/2012/06/wordcount-mapreduce-example-using-hive-on-local-and-emr/

drop table if exists raw_lines;

-- create table raw_line, and read all the lines in '/user/inputs', 
-- this is the path on your local HDFS 
...
-- create table word_count, this is the output table which will be put in '/user/outputs' 
-- as a text file, this is the path on your local HDFS
